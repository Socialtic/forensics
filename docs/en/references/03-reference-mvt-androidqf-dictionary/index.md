...
- [Device configuration](../02-reference-mvt-bugreport-dictionary/index.md#device-configurations)
    - [dumpsys_get_prop.json](../02-reference-mvt-bugreport-dictionary/index.md#getprop.json)
- [Information about logs and system events](../02-reference-mvt-bugreport-dictionary/index.md#information-on-system-logs-and-events)
