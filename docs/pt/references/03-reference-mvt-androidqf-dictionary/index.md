...
- [Configuração do dispositivo](../02-reference-mvt-bugreport-dictionary/index.md#configuração-do-dispositivo-configuração-do-dispositivo)
    - [dumpsys_get_prop.json](../02-reference-mvt-bugreport-dictionary/index.md#getprop.json)
- [Informações sobre registros e eventos do sistema](../02-reference-mvt-bugreport-dictionary/index.md#informações-sobre-registros-e-eventos-do-sistema)
...
Da mesma forma, também listamos os módulos executados pelo ***check-backup***, cujos detalhes estão no final deste recurso.  
...
Este arquivo permite acompanhar a atividade interna do dispositivo, proporcionando uma visão geral de como o dispositivo se comportou e identificando eventos relevantes. 
...
"2025-01-01 00:00:00","Pacotes","package_install","com.example.newapp (sistema: Falso, de terceiros: Verdadeiro)"
```
 ...
 * lazytime: Adia a gravação de carimbos de data/hora no armazenamento para melhorar o desempenho.
 ...
 * uid=0: Proprietário do ponto de montagem (root).
...
As informações deste arquivo são geradas pelo módulo de backup [sms](https://github.com/mvt-project/mvt/blob/main/src/mvt/android/modules/backup/sms.py) e pelo auxiliar de backup [helpers](https://github.com/mvt-project/mvt/blob/main/src/mvt/android/modules/backup/helpers.py) e o analisador [backup](https://github.com/mvt-project/mvt/blob/main/src/mvt/android/parsers/backup.py).
...
[
  {
 "address": "12345",
 "body": "Reative seu aplicativo para continuar aproveitando o serviço. Se tiver algum problema, pedimos que você a reinstale a partir de https://example.com/reactivacion",
 "date": "1597872498518",
